              ...
              <div class="card wow fadeIn special-color-dark note note-danger" data-wow-delay="0.3s">
                <div class="card-body">
                  ...
                  <div class="form-header danger-color">
                    <h3 class="font-weight-500 my-2 py-1 changeIt">Enter Code</h3>
                  </div> 
                  ...
                  <!-- Body -->
                    <div class="form-content">
                        ...
                        <p class="white-text">Enter the verification code generated by Google Authenticator app on your phone.</p>
					</div>
                  ...
                  <div class="md-form ctf-pass">
                    ...
                    <label for="ctf-password">Enter Your 6 Digit Code</label>
                  </div>
