              ...
              <div class="card wow fadeIn special-color-dark note note-danger" data-wow-delay="0.3s">
                <div class="card-body">
                  ...
                  <div class="form-header danger-color">
                    <h3 class="font-weight-500 my-2 py-1 changeIt">Enter backup Code</h3>
                  </div> 
                  ...
                  <!-- Body -->
                    <div class="form-content">
                        ...
                        <p class="white-text">Enter the backup code that generated code on setup two factor code or enter the backup in your google authentacator app to generate 6 digit code.</p>
					           </div>

                  <div class="md-form ctf-pass">
                    <i class="fas fa-lock prefix text-danger"></i>
                    <input type="text" name="code" pattern="" id="ctf-password" class="form-control white-text" required>
                    <label for="ctf-password">Enter Your backup code</label>
                  </div>

                  <div class="text-center">
                    <input type="submit" name="submit" class="btn danger-color btn-lg white-text col-md-12" value="Confirm">
                    ...
                    <p class="white-text"><span> <a href="/login/authentacation/reset" id="signup-now" class="text-danger">Reset your 2 Factors Authentacation?</a></span></p>
                  </div>
                </div>
                </form>
              </div>
