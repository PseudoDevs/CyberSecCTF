...
<html>
<head>
  <title> Sign In | CyberSec CTF </title>
              ...
              <div class="card wow fadeIn special-color-dark note note-danger" data-wow-delay="0.3s">
                <div class="card-body">
                  ...
                  <div class="form-header danger-color">
                    <h3 class="font-weight-500 my-2 py-1 changeIt"><i class="fas fa-user"></i> SIGN IN</h3>
                  </div> 
                  ...
                  <!-- Body -->
                    ...
                    <input type="text" name="username" id="ctf-username" class="form-control text-danger" required>
                    <label for="ctf-username">Username</label>
                  </div>

                  <div class="md-form ctf-pass">
                    <i class="fas fa-lock prefix text-danger"></i>
                    <input type="password" name="password"  id="ctf-password" class="form-control white-text" required>
                    <label for="ctf-password">Your password</label>
                  </div>

                  <div class="text-center">
                    <input type="submit" name="submit" class="btn danger-color btn-lg white-text col-md-12" value="Sign up">
                    <hr class="mt-2 danger-color">
                    <p class="white-text"> Don't have an Account? <span> <a href="/user/sign_up" id="signup-now" class="text-danger"> SIGNUP NOW!</a></span></p>
                    <p class="white-text"><span> <a href="/user/recovery" id="signup-now" class="text-primary">Forgot Password?</a></span></p>
                  </div>
                </div>
                </form>
              </div>
