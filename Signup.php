              ...
              <div class="card wow fadeIn special-color-dark note note-danger" data-wow-delay="0.3s">
                <div class="card-body">
                  ...
                  <div class="form-header danger-color">
                    <h3 class="font-weight-500 my-2 py-1 changeIt"><i class="fas fa-user"></i> SIGN UP</h3>
                  </div> 
               
                <form method="" action="">
                  <!-- Body -->
                  <div class="md-form ctf-fullname">
                    <i class="fa fa-user-o prefix text-danger"></i>
                    <input type="text" id="ctf-name" class="form-control text-danger" required>
                    <label for="ctf-name">Full name</label>
                  </div>

                    <div class="md-form ctf-fullname">
                    <i class="fa fa-user-secret prefix text-danger"></i>
                    <input type="text" id="ctf-username" class="form-control text-danger" required>
                    <label for="ctf-username">Username</label>
                  </div>


                  <div class="md-form ctf-mail">
                    <i class="fa fa-envelope-o prefix text-danger"></i>
                    <input type="text" id="ctf-email" class="form-control white-text" required>
                    <label for="ctf-email">Your email</label>
                  </div>

                  <div class="md-form ctf-pass">
                    <i class="fas fa-lock prefix text-danger"></i>
                    <input type="password" id="ctf-password" class="form-control white-text" required>
                    <label for="ctf-password">Your password</label>
                  </div>

                   <div class="md-form ctf-git">
                    <i class="fa fa-github prefix text-danger"></i>
                    <input type="text" id="github-username" class="form-control white-text">
                    <label for="github-username">Github (optional)</label>
                  </div>


                   <div class="md-form ctf-hackone">
                    <i class="fa fa-terminal prefix text-danger"></i>
                    <input type="text" id="hackerone-username" class="form-control white-text">
                    <label for="hackerone-username">Hackerone (Optional)</label>
                  </div>


                  <div class="text-center">
                   <button class="btn danger-color btn-lg white-text col-md-12">Sign up</button>
                    <hr class="mt-2 danger-color">
                    <p class="white-text"> Already have an Account? <span> <a href="Login.php" id="login-now" class="text-danger"> LOGIN NOW!</a></span></p>
                  </div>
